...
export default function AccountDetails() {
  ...
  return (
    <>
      {(account?.data?.transactions?.length <= 0  && account?.data?. initialBalance<=0) ? (
        <>
        <h2 className="text-center text-red-500">This Account Does Not Have Any Transactions</h2>
        ...
        (<><div className="bg-gray-50 pt-12 sm:pt-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-3 text-xl text-gray-500 sm:mt-4">
                  Below are the transactions for your account {account?.data?.name}
              </p>
            </div>
          </div>
          ...
          <AllTransactions initBal={account?.data?.initialBalance} transactions={account?.data?.transactions} accountID={accountID}/>
